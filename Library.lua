...
writefile("Roboto-Regular.ttf", game:HttpGet("https://github.com/Saintnonly/Fang.cc/raw/main/Roboto-Regular.ttf"))
...
do
	...
	Font:Register("menu_plex", 400, "normal", {Id = "Roboto-Regular.ttf", Font = ""});
end
